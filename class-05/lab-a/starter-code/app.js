...
function sumArray(sumArr) { //eslint-disable-line
  ...
  y = y[0];
  let msg3 = sumArr[0]+','+sumArr[1]+','+sumArr[2]+' was passed in as an array of numbers, and '+y+' is their sum.';

sumArr = sum(x[0],sumArr[2]) ;


  return [sumArr[0],msg3]
}
...
in this function. To do multiplication, use your multiply() function 
that you've already created. You're going to have to be resourceful to figure out how to do this. 
This function should handle an array containing three elements. However, you may continue to use the + 
operator for string concatenation.

Test this function by hand in the console to get it working,
 and when you think it is finished, uncomment the call for the testMultiplyArray() 
 function and see if the test passes.*/

// Write your code here
function multiplyArray(multArr) { //eslint-disable-line
  let x =multiply(multArr[0],multArr[1]);
  let y = multiply(x[0],m[2]);
  y = y[0];
  let msg4 = 'The numbers '+multArr[0]+','+multArr[1]+','+multArr[2]+' have a product of 24.';

multArr = multiply(x[0],multArr[2]) ;


  return [multArr[0],msg4]
}
