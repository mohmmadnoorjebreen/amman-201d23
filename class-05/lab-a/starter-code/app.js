...
<<<<<<< HEAD
  let x = sum(a,b);
  let sumAndMultiplyS = sum(x[0],c);
  let y = multiply(a,b)
  let sumAndMultiplyM = multiply(y[0],c);
  let msg =  a +' and '+ b +' and '+ c +' sum to '+ sumAndMultiplyS[0] +'.';
  let msg2 = 'The product of '+ a +' and '+ b +' and '+c+' is '+ sumAndMultiplyM[0] +'.';
